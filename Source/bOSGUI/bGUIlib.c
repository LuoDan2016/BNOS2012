...
/*
* ASCII码表 8x16x255
* 按ASCII表顺序 从第一行开始向右每取8个点作为一个字节，
* 如果最后不足8个点就补满8位。8位逐行取模 第一点为高位 如
* N：0x00,0x00,0x00,0xC7,0x62,0x62,0x52,0x52,0x4A, 
* 0x4A,0x4A,0x46,0x46,0xE2,0x00,0x00
*/
/* font8x16 char */
const unsigned char code __ASCII816[] = 
{
