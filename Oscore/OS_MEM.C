...
*
* Description : Create a fixed-sized memory partition that will be managed by BNOS 2012.
*
...
*
* Description : This function is called by BNOS 2012 to initialize the memory partition manager.  Your
...
* Returns     : none
*
* Note(s)    : This function is INTERNAL to BNOS 2012 and your application should not call it.
*********************************************************************************************************
*/
