...
*                                            CREATE A TASK
*
* Description: This function is used to have BNOS 2012 manage the execution of a task.  Tasks can either
...
*                       LOWER 8-bits are reserved by BNOS 2012 while the upper 8 bits can be application
...
*              OS_TASK_DEL_IDLE    if you attempted to delete BNOS 2012's idle task
*              OS_PRIO_INVALID     if the priority you specify is higher that the maximum allowed
...
*                 The task can then be 'unlinked' from the miscellaneous structures in BNOS 2012.
...
*              OS_TASK_DEL_IDLE   if you requested to delete BNOS 2012's idle task
*              OS_PRIO_INVALID    if the priority you specify is higher that the maximum allowed
*                                 (i.e. >= OS_LOWEST_PRIO) or, you have not specified OS_PRIO_SELF.
