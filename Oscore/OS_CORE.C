...
*                                             INITIALIZATION
*
* Description: This function is used to initialize the internals of BNOS 2012 and MUST be called prior to
*              creating any BNOS 2012 object and, prior to calling OSStart().
*
* Arguments  : none
*
* Returns    : none
...
*                                              ENTER ISR
*
* Description: This function is used to notify BNOS 2012 that you are about to service an interrupt
*              service routine (ISR).  This allows BNOS 2012 to keep track of interrupt nesting and thus
...
*                                               EXIT ISR
*
* Description: This function is used to notify BNOS 2012 that you have completed serviving an ISR.  When
*              the last nested ISR has completed, BNOS 2012 will call the scheduler to determine whether
...
*                                          START MULTITASKING
*
* Description: This function is used to start the multitasking process which lets BNOS 2012 manages the
...
*                                         PROCESS SYSTEM TICK
*
* Description: This function is used to signal to BNOS 2012 the occurrence of a 'system tick' (also known
...
*                                             GET VERSION
*
* Description: This function is used to return the version number of BNOS 2012.  The returned value
*              corresponds to BNOS 2012's version number multiplied by 100.  In other words, version 2.00
*              would be returned as 200.
*
* Arguments  : none
*
* Returns    : the version number of BNOS 2012 multiplied by 100.
*********************************************************************************************************
*/
...
*
* Description: This function is called by other BNOS 2012 services and is used to ready a task that was
...
* Returns    : none
*
* Note       : This function is INTERNAL to BNOS 2012 and your application should not call it.
*********************************************************************************************************
*/
#if OS_EVENT_EN > 0
...
*
* Description: This function is called by other BNOS 2012 services to suspend a task because an event has
*              not occurred.
*
...
*
* Description: This function is called by other BNOS 2012 services to make a task ready to run because a
*              timeout occurred.
*
...
*
* Description: This function is called by other BNOS 2012 services to initialize the event wait list.
*
...
*                                              SCHEDULER
*
* Description: This function is called by other BNOS 2012 services to determine whether a new, high
...
* Returns    : none
*
* Notes      : 1) This function is INTERNAL to BNOS 2012 and your application should not call it.
*              2) Rescheduling is prevented when the scheduler is locked (see OSSchedLock())
*********************************************************************************************************
*/
...
*                                              IDLE TASK
*
* Description: This task is internal to BNOS 2012 and executes whenever no other higher priority tasks
...
*                 enabled before they were disabled again.  BNOS 2012 would thus never recognize
*                 interrupts.
...
void  OS_TaskIdle (void *ppdata) reentrant
{
#if OS_CRITICAL_METHOD == 3                      /* Allocate storage for CPU status register           */
    OS_CPU_SR  cpu_sr;
#endif    
...
*                                            STATISTICS TASK
*
* Description: This task is internal to BNOS 2012 and is used to compute some statistics about the
...
*                                         OSIdleCtrMax
*
* Arguments  : ppdata     this pointer is not used at this time.
*
* Returns    : none
*
...
*                                            INITIALIZE TCB
*
* Description: This function is internal to BNOS 2012 and is used to initialize a Task Control Block when
